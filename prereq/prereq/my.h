...
int my_strfind(char*, char); //ok
int my_strrfind(char*,char);//ok
...
char * get_left(char*);//ok
char * get_right(char*);//ok
bool is_and_expression(char*);//ok
bool is_or_expression(char*);//ok
bool is_unit_expression(char*);  //ok

/*
void push(char,char*,int); //ok
char pop(char*);//ok
char top(char*);//ok
bool is_empty(char*,int ); //ok
*/
